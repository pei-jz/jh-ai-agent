...
class ConversationMemory {
     ...
     */
    setBudgetConfig(cfg = {}) {
        // An explicit null still lands here (defaults only cover `undefined`).
...
${list}`;
    ...
    async compactHistory(history, modelId = '', fileCache = null, onLog = null) {
        // Nothing to compact — return the input shape rather than throwing on
        // a caller that handed us an empty/absent history.
