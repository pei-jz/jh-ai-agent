...
`;
    ...
    getPromptContext() {
        ...
        // NOTE: instructions.md is deliberately NOT included here. It is the
        // user's own normative ruleset, so ContextBuilder emits it as its own
        // <project_instructions> block that is exempt from trimming — bundling
        // it into this auto-generated summary meant trimToFit could cut the
        // middle out of the user's rules while keeping a machine-made file
        // listing. Read it via getProjectInstructions().
        return context;
    }

    /** The workspace's own rules (.agent/instructions.md), verbatim. */
    getProjectInstructions() {
        return this.markdownInstructions || '';
    }
}
